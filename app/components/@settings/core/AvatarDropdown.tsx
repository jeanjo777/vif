      ...
      <DropdownMenu.Portal>
        ...
        >
          ...
          <DropdownMenu.Item
            ...
            onClick={() =>
              window.open('https://github.com/jeanjo777/doudou-chat/issues/new?template=bug_report.yml', '_blank')
            }
          >
          ...
          <DropdownMenu.Item
            ...
            onClick={() => window.open('https://github.com/jeanjo777/doudou-chat', '_blank')}
          >
