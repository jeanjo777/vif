  ...
  return (
    ...
    >
      <div className="h-full">
        <div className="bg-vif-elements-terminals-background h-full flex flex-col">
          <div className="flex items-center bg-vif-elements-background-depth-2 border-y border-vif-elements-borderColor gap-1.5 min-h-[34px] p-2">
                  ...
                  {index == 0 ? (
                    <button
                      ...
                      className={classNames(
                        ...
                        {
                          'bg-vif-elements-terminals-buttonBackground text-vif-elements-textSecondary hover:text-vif-elements-textPrimary':
                            isActive,
                          'bg-vif-elements-background-depth-2 text-vif-elements-textSecondary hover:bg-vif-elements-terminals-buttonBackground':
                            !isActive,
                        },
                      )}
                    ...
                    <React.Fragment>
                      <button
                        ...
                        className={classNames(
                          'flex items-center text-sm cursor-pointer gap-1.5 px-3 py-2 h-full whitespace-nowrap rounded-full',
                          {
                            'bg-vif-elements-terminals-buttonBackground text-vif-elements-textPrimary': isActive,
                            'bg-vif-elements-background-depth-2 text-vif-elements-textSecondary hover:bg-vif-elements-terminals-buttonBackground':
                              !isActive,
                          },
                        )}
                      ...
                      >
                        ...
                        <button
                          className="bg-transparent text-vif-elements-textTertiary hover:text-vif-elements-textPrimary hover:bg-transparent rounded"
                          onClick={(e) => {
                            e.stopPropagation();
                            closeTerminal(index);
                          }}
            ...
            <IconButton
              ...
              onClick={() => {
                ...
                if (ref?.getTerminal()) {
                  ...
                  if (activeTerminal === 0) {
                    workbenchStore.attachVifTerminal(terminal);
                  } else {
          ...
          {Array.from({ length: terminalCount + 1 }, (_, index) => {
            ...
            logger.debug(`Starting Vif Terminal [${index}]`);
              ...
              return (
                <React.Fragment key={`terminal-container-${index}`}>
                  <Terminal
                    ...
                    onTerminalReady={(terminal) => workbenchStore.attachVifTerminal(terminal)}
